...
= 3.2 =
Resolved issues with menus dissapearing on custom taxonomy archive pages. Normalized custom URLs to make it easier to match custom links in the menu to the current page.